...
add wave -noupdate -group "L0_N0_PIPE" -position insertpoint sim:/my_uvm_tb/dut/u_l0_n0/active
add wave -noupdate -group "L0_N0_PIPE" -position insertpoint -radix unsigned sim:/my_uvm_tb/dut/u_l0_n0/cnt
add wave -noupdate -group "L0_N0_PIPE" -position insertpoint sim:/my_uvm_tb/dut/u_l0_n0/s0_valid
add wave -noupdate -group "L0_N0_PIPE" -position insertpoint sim:/my_uvm_tb/dut/u_l0_n0/s1_valid
add wave -noupdate -group "L0_N0_PIPE" -position insertpoint -radix decimal sim:/my_uvm_tb/dut/u_l0_n0/acc
add wave -noupdate -group "L0_N0_PIPE" -position insertpoint sim:/my_uvm_tb/dut/u_l0_n0/done_pending
add wave -noupdate -group "L0_N0_PIPE" -position insertpoint sim:/my_uvm_tb/dut/u_l0_n0/valid_out
